...
exports.requestVacation = async (
    ...
    const vacationsInsideRequest = await getVacationsInRange(
        employeeId,
        startDate,
        endDate,
    );
    ...
    const vacationsOutsideRequest = await getOutsideVacations(
        employeeId,
        startDate,
        endDate,
    );
...
exports.registerEmployeeVacation = async ({
    ...
    const remainingVacationResult =
        await getRemainingVacations(targetEmployeeId);
    const remainingVacations = remainingVacationResult.data.remainingDays;
    const anniversaryStartDate = remainingVacationResult.data.startDate;
    const anniversaryEndDate = remainingVacationResult.data.endDate;
