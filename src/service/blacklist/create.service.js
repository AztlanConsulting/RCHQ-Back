...
const {
    transactionalBlacklistInsert,
} = require("../../model/blacklist/update.model");
...
exports.insertIntoBlacklist = async (curp, executorId, ipAddress) => {
    try {
        ...
        if (employee.isBlacklisted)
            return { code: RESPONSES.BLACKLIST.ALREADY_EXISTS };
        ...
        try {
            ...
            warning =
                "Empleado agregado a la lista negra, pero falló el registro de auditoría (log).";
        }
        ...
        console.error(
            "Error inesperado en insertIntoBlacklist service:",
            error,
        );
