    ...
    try {
        ...
        if (result.code === RESPONSES.VACATION.INSUFFICIENT_DATES) {
            return res.status(406).json({
                success: false,
                message:
                    "No se tienen suficientes días disponibles para registrar las vacaciones",
            });
        }
