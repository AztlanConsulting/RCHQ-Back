const RESPONSES = {
    ...
    EVENTS: {
        ...
        EMPLOYEE_NOT_IN_EVENT: "EVENT_EMPLOYEE_NOT_IN_EVENT",
        EMPLOYEE_REMOVED: "EVENT_EMPLOYEE_REMOVED",
        NOT_TRAINING_EVENT: "EVENT_NOT_TRAINING_EVENT",
    },
    ABSENCE: {
    ...
    BENEFICIARY: {
        ADDED: "BENEFICIARY_ADDED",
        ALREADY_REGISTERED_IN_SAME_HOUSE:
            "BENEFICIARY_ALREADY_REGISTERED_IN_SAME_HOUSE",
        ALREADY_REGISTERED_IN_OTHER_HOUSE:
            "BENEFICIARY_ALREADY_REGISTERED_IN_OTHER_HOUSE",
        BAD_REQUEST: "BENEFICIARY_BAD_REQUEST",
    },
    BLACKLIST: {
