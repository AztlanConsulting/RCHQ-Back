...
const validAdminBody = {
    ...
    workdays: [
        {
            workdayId: "d0000001-0000-4000-8000-000000000001",
            start: "08:00",
            end: "17:00",
        },
    ],
...
beforeEach(() => {
    ...
    getFrecuencyPaymentOptions.mockResolvedValue([
        { id: "f1", name: "Quincenal" },
    ]);
});
...
describe("getUpdateFormData", () => {
    ...
    it("propaga el error si algún modelo falla", async () => {
        ...
        await expect(getUpdateFormData({ houseId: "h1" })).rejects.toThrow(
            "DB error",
        );
    });
});
