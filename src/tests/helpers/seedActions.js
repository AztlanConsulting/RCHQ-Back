...
const ACTIONS = [
    {
                ...
                {
                    action_id: "auth-014",
                    description: "Intento de configuración de autenticación en dos pasos para usuario inactivo",
                    important: false,
                },
                {
                    action_id: "auth-015",
                    description: "Intento de verificación autenticación en dos pasos para usuario inactivo",
                    important: false,
                },
                {
                    action_id: "auth-016",
                    description: "Intento de validación de autenticación en dos pasos para usuario inactivo",
                    important: false,
                },
                {
                    action_id: "auth-017",
                    description: "Intento de desactivación de autenticación en dos pasos para usuario inactivo",
                    important: false,
                },
                {
                    action_id: "auth-018",
                    description: "Fallo de desactivación de autenticación en dos pasos por contraseña incorrecta",
                    important: false,
                },
                {
                    action_id: "auth-019",
                    description: "Autenticación en dos pasos bloqueada temporalmente por múltiples intentos fallidos",
                    important: false,
                },
                {
                    action_id: "empl-001",
